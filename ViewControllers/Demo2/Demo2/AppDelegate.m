...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSLog(@"isViewLoaded = %d", rootViewController.isViewLoaded); //проверяем загружена ли вью
    NSLog(@"-----------");

    rootViewController.view; //обращаемся к вью чтобы запустить жизненный цикл
